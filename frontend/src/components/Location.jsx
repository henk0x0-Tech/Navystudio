        ...
        >
            <div className="container">
                ...
                <header className={`section-title ${isVisible ? 'animate-slide-up' : ''}`}>
                    ...
                    <h2 id="location-heading">Visit Navya Makeup Artist in Bangalore</h2>
                    <p className="section-subtitle">
                        Visit us at our studio in Medahalli, Bengaluru or book a home service appointment for bridal makeup
                    </p>
                </header>
                ...
                <div className="location__wrapper">
                    ...
                    <aside className={`location__info ${isVisible ? 'animate-slide-up' : ''}`}>
                        <div className="location__info-card">
                            ...
                            <h3 itemProp="name">Navya Makeup Artist - Studio Address</h3>
