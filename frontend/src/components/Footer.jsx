...
const Footer = () => {
    ...
    const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi%20Navya!%20I%20have%20a%20query%20about%20your%20makeup%20services.`;
            ...
            <div className="container">
                <div className="footer__content">
                    ...
                    <div className="footer__brand">
                        <a
                            ...
                            aria-label="Navya Makeup & Hairstyle - Back to top"
                        >
                            <span className="footer__logo-text">Navya</span>
                            <span className="footer__logo-tagline">Makeup & Hairstyle</span>
                        </a>
                        <p className="footer__description">
                            Premium bridal makeup artist in Bangalore. Specializing in bridal, party, and pre-wedding shoot makeup.
                            Book your appointment for a stunning transformation on your special day.
                        </p>
                        <div className="footer__social" role="list" aria-label="Social media links">
                            ...
                            <a
                                ...
                                role="listitem"
                                aria-label="Contact Navya Makeup Artist on WhatsApp"
                            >
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            ...
                            <a
                                ...
                                className="footer__social-link"
                                role="listitem"
                                aria-label="Email Navya Makeup Artist"
                            >
                    ...
                    {/* Services Links */}
                    <nav className="footer__services" aria-label="Our makeup services">
                        <h3 className="footer__heading">Our Services</h3>
                        <ul className="footer__list">
                            <li>
                                <a href="#services" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>
                                    Bridal Makeup in Bangalore
                                </a>
                            </li>
                            <li>
                                <a href="#services" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>
                    ...
                    >
                        ...
                        <ul className="footer__contact-list">
                            <li>
                                ...
                                <a
                                    ...
                                    itemProp="telephone"
                                    aria-label="Call Navya Makeup Artist"
                                >
                                    +91 63665 15258
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                >
                                    <span itemProp="streetAddress">CSR Golden Gate, Hosabasavanapura, Medahalli</span>
                                    <span>
                        ...
                        <a
                            ...
                            aria-label="Book bridal makeup via WhatsApp"
                        >
                ...
                <div className="footer__bottom">
                    <p className="footer__copyright">
                        © {currentYear} Navya Makeup & Hairstyle. All rights reserved. |
